      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
          ...
          <p className="mb-6 text-lg text-center">
            Máte dotazy ohledně koncertů, vstupenek nebo technického zázemí?
            Podívejte se na naše kontaktní údaje nebo se zastavte přímo u nás.
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="sm:col-span-2">
              ...
              <p>
                Po–Pá: 9:00 – 18:00
                <br />
                Víkendy: podle aktuálního programu
              </p>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <p className="mb-2">
              Nejrychlejší spojení je metrem linky B na stanici Českomoravská.
              Dále můžete využít tramvaje č. 8, 25 nebo 52.
            </p>
            <p>
              Pro návštěvníky je k dispozici parkování v bezprostřední blízkosti
              arény.
            </p>
            <img
              src="/vstup.jpg"
              alt="Vstup do O2 Areny"
